...
class ObservableConcurrencyTests: XCTestCase {
    ...
    func testFullHandler() {
        var x = Observable(0, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
        var t : (Int, Int) = (-1, -1)
    ...
    func testAddHandlerToOptional() {
        var original = Observable(0, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
    ...
    func testValueAfterCopy() {
        let original = Observable(0, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
    ...
    func testPairObservable() {
        var (first, last) = (Observable("John", queue:dispatch_queue_create("John",DISPATCH_QUEUE_CONCURRENT)), Observable("Smith", queue:dispatch_queue_create("Smith",DISPATCH_QUEUE_CONCURRENT)))
    ...
    func testTripleObserver() {
        var (title, first, last) = (Observable("Mr.", queue:dispatch_queue_create("Mr",DISPATCH_QUEUE_CONCURRENT)), Observable("John", queue:dispatch_queue_create("John",DISPATCH_QUEUE_CONCURRENT)), Observable("Smith", queue:dispatch_queue_create("Smith",DISPATCH_QUEUE_CONCURRENT)))
    ...
    func testObservablePair() {
        var both = Observable(("John", "Smith"), queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
    ...
    func testObservableTriple() {
        var either3 = Observable(("Mr.", "John", "Smith"), queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
    ...
    func testObservableStruct() {
        ...
        var person = Observable(Person(first: "John", last: "Smith"), queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
    ...
    func testStructModifiedWhenPropertyModified() {
        ...
        var person = Observable(Person(first: "John", last: Observable("Doe", queue:dispatch_queue_create("Doe",DISPATCH_QUEUE_CONCURRENT))), queue:dispatch_queue_create("John",DISPATCH_QUEUE_CONCURRENT))
    ...
    func testReferences() {
        let x = ObservableReference(0, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
        x <- 1
        XCTAssertEqual(x^, 1, "Should be equal to one")
    }
    
    func testChainingWithStructs() {
        struct Test { var test = Observable(0, queue:dispatch_queue_create("Test",DISPATCH_QUEUE_CONCURRENT)) }
    ...
    func testChainingWithOptionals() {
        class Person {
            ...
            var friend: Observable<Person?> = Observable(nil, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
            
            init(first: String, last: String) {
                firstName = first
                lastName = Observable(last, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
            }
        }
    ...
    func testChainingWithOwner() {
        struct Test { var test = Observable(0, queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT)) }
    ...
    func testChainingCleanup() {
        ...
        struct Test { var test = Observable(0, queue:dispatch_queue_create("Test Queue", DISPATCH_QUEUE_CONCURRENT)) }
        
        var afterTimes = 0
        var test = Observable(Test(), queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
    ...
    func testObservingAnArray() {
        let ref = [1, 2, 3, 42]
        var comp : [Int] = []
        var vals = Observable<[Int]>([], queue:dispatch_queue_create(nil,DISPATCH_QUEUE_CONCURRENT))
        var changes = 0
